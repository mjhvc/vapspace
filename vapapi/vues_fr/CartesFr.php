...
<body>
  ...
  <div id="corpsPictos"><!--corpsPictos-->
    <h3> Vos cartes VAP avec destination personnalisable !</h3>
    <p class="cartes">Ce carton d'auto-stop vous identifie comme <strong>membre du réseau VAP</strong> <br />
        Deux formats d'impression: A4 et 10x15 cm <br />
        Bon voyage ! ;</p>
    <div id="flashContent">
    ...
    <p class="signature"><!--signature-->
      L'équipe des VAP <br />
      Pour un usage partagé de l'automobile.
    </p>
   <br class="nettoyeur"/>
  </div>
  <div id="pied">
