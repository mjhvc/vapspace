  ...
  <div id="dataPerso"> 
    ...
    <h3 class="space">Recommander les VAP</h3>   
      <form id="promoVap"><p>
        ...
        <label for="promoUn">Premier courriel : </label><br /><input type="text" name="promoUn" id="promoUn" size="15" maxlength="60" value="" /><br />
        <label for="promoDeux">Second courriel : </label><br /><input type="text" name="promoDeux" id="promoDeux"  size="15" maxlength="60" value="" /><br />
        <label for="promoTrois">Dernier courriel : </label><br /><input type="text" name="promoTrois" id="promoTrois"  size="15" maxlength="60" value="" /><br />
