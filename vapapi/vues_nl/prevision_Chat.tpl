<ul>
  <li class="cadreforum">
    <div class=forumtete> 
      <span>Het {tampon} &nbsp;&nbsp; {pseudo},&nbsp;&nbsp; antenne: {vapattache} &nbsp;&nbsp;&nbsp; {vaputile} </span>
    </div>
    <p class="sujetforum"><span>Onderwerp : </span> {sujet} </p>
    <p class="forum"><span>Boodschap : </span> {message} </p>  
    <p class="forumqueue">Antwoord </p>
  </li>
</ul>
<form method="post" action="{script_formu}">
<p class="formubouton"><input type="submit" value="Verbeteren" name="chatcorr" /><input type="submit" name="chatpost" value="Verzenden" /></p>
<p class="formucache">
